...
class BasePlayerStrategy {
    static get type() { throw new Error('子类必须定义静态 type'); }
    static get displayName() { throw new Error('子类必须定义静态 displayName'); }
     ...
     * @returns {boolean}
     */
    static checkAvailable(execPath) { // eslint-disable-line no-unused-vars
        return false;
    }
     ...
     */
    start(filePath, position, callbacks, sessionId) { // eslint-disable-line no-unused-vars
...
module.exports = { BasePlayerStrategy };
