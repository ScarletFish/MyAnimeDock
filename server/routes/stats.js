...
module.exports = {
  ...
  handleStatsSeasons(req, res, state) {
    const { data } = state;
    const lib = data.library || [];
  ...
  handleStatsRatings(req, res, state) {
    const { data } = state;
    const lib = data.library || [];
  ...
  handleStatsWatchActivity(req, res, state) {
    const { data } = state;
  ...
  handleAnimeSessions(req, res, state) {
    const { data } = state;
