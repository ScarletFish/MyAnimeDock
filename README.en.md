...
- **mpv Playback & Progress Tracking**: Tracks playback progress in real time via the IPC pipe with auto-save and resume support; optional per-episode mark dialog with precise tracking of the current episode (new setting).
